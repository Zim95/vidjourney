...
def ingest(pdf_path: Path) -> None:
    ...
    split_code_sections: list[list[tuple[int, PageElement]]] = CodeCleanupUtils.split_code_blocks_by_ml(cleaned_code_sections)
    merged_code_sections: list[list[tuple[int, PageElement]]] = CodeMergeUtils.combine_split_code_blocks(split_code_sections)
